	...
	<table  border="1" align="center" bgcolor="#99CCFF" cellpadding="0" cellspacing="0" width="780">
          <tr  bgcolor="#99CCFF"> 
            <td  bgcolor="#9933FF" align="center"> 
             <font color="#FFFFFF">搜尋產品庫存資料</font>
            </td> 
			  <td align="center"> 
              <input type="submit" name="submit" value="搜尋產品庫存資料完成,回首頁">
            </td>                 
          </tr>
        </table>
        ...
        <br> 
		<table width="780" border="1" cellpadding="0" cellspacing="0"   bgcolor="#FFCC00"  align="center">
		 <tr> 
            <td width="103" height="22" align="center">期初庫存量</td>
            <td width="187" height="22"><?=$row[prodpqty]?>             
            </td>
            <td width="96" height="22" align="center">現有庫存量</td>              
            <td width="351" height="22"><?=$row[prodnqty]?>	
            </td>
          </tr>
		  </table>          
      </td>
