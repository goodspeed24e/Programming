...
//--------------計算總筆數及頁數------------------
	...
	$lista=ceil($total/10);
?>
<!----執行搜尋頁面呈現,傳入搜尋條件給invqty_inq2.php------------------------->
<form name="form1" method="post" action="inv/invqty_inq2.php">
  <table width="782" border="1" align="center" cellspacing="0" cellpadding="0" >
    <tr bgcolor="#99CCFF"> 
      <td align="center">
		 <?php
//--------------頁數選擇呈現及連接---------------
     echo "搜尋產品庫存資料&nbsp;&nbsp; 第&nbsp";
	for($i = 1;$i<=$lista;$i++) 
	{
...
// 抓取資料表中其他資料並呈現
			...
			echo "<td align='center'><a href='inv/invqty_inq2.php?prodno=" . $prodno . "'>" . $prodname . "</a></td>\n";
