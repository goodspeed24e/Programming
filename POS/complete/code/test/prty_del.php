...
<form name="form1" method="post" action="iwmfile_prty_del_db.php">
  ...
  <table width="750" border="1" cellspacing="0" cellpadding="0" bordercolor="#9999FF">
    <tr>
      <td>
        <table width="750" border="1" cellspacing="0" bgcolor="#FFFFFF"  cellpadding="0">
          <tr> 
