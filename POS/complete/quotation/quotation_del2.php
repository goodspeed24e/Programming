...
<!------ 傳給 quotation_del3.php 檔案 ------>
<form name="form1" method="post" action="quotation_del3.php?quwkno='.$quwkno.'&quwkprod='.$quwkprod.'&quwkcust='.$quwkcust.'">
  <table width="770" border="1" cellpadding="0" cellspacing="0" align="center" >
	...
	<table width="770">
	  <tr>
            <td align="center"> 
              <input type="submit" name="submit" value="刪除報價資料">
            </td>
	  </tr>
  </table>
