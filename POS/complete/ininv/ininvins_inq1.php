...
<?php
	...
	$lista=ceil($total/10);
?>
<!----傳給ininvins_inq2.php,執行搜尋---------->
<form name="form1" method="post" action="ininv/ininvins_inq2.php">
 ...
 <?php
	...
	for($i = 1;$i<=$lista;$i++) 
	{
		echo "  <a href=index.php?Select=366&page=$i>$i</a>|";
	}
...
<?php
      ...
      while (list($trancode, $trandate, $tranno, $tranpono, $tranremark, $tranvendno, $tranprodno, $tranprodname, $tranprodqty, $tranunit, $tranpric, $tranamt)=mysql_fetch_row($res))
        ...
        //---------------- 抓取進貨資料表中資料並呈現---------------------
			...
			echo "<td align='center'><a href='ininv/ininvins_inq2.php?tranprodno=" . $tranprodno . "&tranpono=" . $tranpono . "&tranno=" . $tranno . "'>" . $tranprodno . "</a></td>\n";
