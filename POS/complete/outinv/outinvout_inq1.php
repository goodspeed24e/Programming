...
//--------------計算總筆數及頁數------------------
	...
	$lista=ceil($total/10);
?>
<form name="form1" method="post" action="outinv/outinvout_inq2.php">
...
//--------------頁數選擇呈現及連接---------------
	...
	for($i = 1;$i<=$lista;$i++) 
	{
		echo "  <a href=index.php?Select=406&page=$i>$i</a>|";
	}
...
//---------------- 抓取銷貨資料表中資料並呈現---------------------
			...
			echo "<td align='center'><a href='outinv/outinvout_inq2.php?outino=" . $outino . "&outiprodno=" . $outiprodno . "'>" . $outiprodno . "</a></td>\n";
