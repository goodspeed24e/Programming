...
//--------------計算總筆數及頁數------------------
	...
	$lista=ceil($total/10);
?>
<form name="form1" method="post" action="vend/vendbasic_mod2.php">
...
//--------------頁數選擇呈現及連接---------------
	...
	for($i = 1;$i<=$lista;$i++) 
	{
		echo "  <a href=index.php?Select=202&page=$i>$i</a>|";
	}
...
//-----------------連接vendbasic_mod2-------------------						
			echo "<td align='center'><a href='vend/vendbasic_mod2.php?vendno=" .$vendno. "'>" .$vendname. "</a></td>\n";
