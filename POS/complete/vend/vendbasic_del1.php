...
//--------------計算總筆數及頁數------------------
	...
	$lista=ceil($total/10);
?>
<form name="form1" method="post" action="vend/vendbasic_del2.php">
...
//--------------頁數選擇呈現及連接---------------
	...
	for($i = 1;$i<=$lista;$i++) 
	{
		echo "  <a href=index.php?Select=204&page=$i>$i</a>|";
	}
...
//----------------連接刪除頁面----------------------------------------						
			echo "<td align='center'><a href='vend/vendbasic_del2.php?vendno=" .$vendno. "'>" .$vendname. "</a></td>\n";
