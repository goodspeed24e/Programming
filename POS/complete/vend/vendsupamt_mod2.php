...
?>
<!---傳出搜尋條件,執行vendsupamt_mod3.php----->
<form name="form1" method="post" action="vendsupamt_mod3.php?vendno='.$vendno.'">
  <table width="770" border="1" cellpadding="0" cellspacing="0" align="center" >
    <tr> 
      <td  bgcolor="#FFFFFF">  
        <table width="770" border="0" align="center">
          <tr> 
            <td width="50%" bgcolor="#9933FF" align="center"><font color="#FFFFFF">應付帳款設定</font>
            </td>
            <td align="center"> 
              <input type="submit" name="submit" value="修改應付帳款設定">
            </td>
	  </tr>
  </table>
<!--//------------修改資料內容呈現,應付帳款資料-------------------------------------------->
