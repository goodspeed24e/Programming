      ...
      <td   bgcolor="#FFFFFF">  
        <table width="770" border="0" align="center">
          <tr> 
            ...
            <td align="center"> 
              <input type="submit" name="submit" value="搜尋廠商資料">
            </td>
	  </tr>
        </table>
        <table width="770" border="0" cellpadding="1" cellspacing="1" bgcolor="#99CCFF" >
		   <tr> 
            ...
            <td width="209" align="left" colspan="3"><?=$row[vendno]?></td>            
          </tr>
          <tr>           
            ...
            <td width="201" align="left"><?=$row['vendsname']?></td>
          </tr>
          <tr> 
            <td width="86" align="center">廠商名稱</td>
            <td width="209" align="left"><?=$row['vendname']?></td>
            <td width="85" align="center">負責人</td>
            <td width="201" align="left"><?=$row['vendleader']?></td>
          </tr>
          <tr>
            <td width="86" align="center">統一編號</td>
            <td width="209" align="left"><?=$row['vendinvoice']?></td>
            <td width="85" align="center">聯絡人</td>
            <td width="201" align="left"><?=$row['vendcontact']?></td>
          </tr>
          <tr>
            <td width="86" height="22" align="center">聯絡電話</td>
            <td width="209" height="22" align="left"><?=$row['vendtel']?></td>
            <td width="85" height="22" align="center">聯絡手機</td>
            <td width="201" height="22" align="left"><?=$row['vendmobil']?></td>
          </tr>
          <tr>            
            <td width="86" height="22" align="center">傳真機</td>
            <td width="209" height="22" align="left"><?=$row['vendfax']?></td>
			<td width="85" height="22" align="center">業務員</td>
            <td width="201" height="22" align="left"><?=$row['vendsales']?></td>           
          </tr>
		 <tr>
			<td width="103" height="22" align="center">公司地址</td>
            <td width="187" height="22"><?=$row['vendadr']?></td>           
          </tr>
		  <tr>
			<td width="103" height="22" align="center">送貨地址</td>
            <td width="187" height="22"><?=$row['vendpradr']?></td>           
          </tr>
		  <tr>
			<td width="103" height="22" align="center">發票地址</td>
            <td width="187" height="22"><?=$row['vendinadr']?></td>           
          </tr>
		  <tr> 
            <td width="103" align="center">電子信箱</td>
            <td width="187"><?=$row['vendemail']?></td>
		  </tr>
		  <tr> 
            <td width="96" align="center">網址</td>
            <td width="351"><?=$row['vendhttp']?></td>
          </tr>    
		</td>
    </tr> 
  </table>
