...
//--------------計算總筆數及頁數------------------
	...
	$lista=ceil($total/10);
?>
<!---傳出修改條件,執行vendsupamt_mod2.php----->
<form name="form1" method="post" action="vend/vendsupamt_mod2.php?vendno='.$vendno.'">
  <table width="782" border="1" align="center" cellspacing="0" cellpadding="0" >
    <tr> 
      <td align="center" bgcolor="#99CCFF">
<?php
//--------------頁數選擇呈現及連接---------------
     echo "修改應付帳款資料&nbsp;&nbsp; 第&nbsp";
	for($i = 1;$i<=$lista;$i++) 
	{
		echo "  <a href=index.php?Select=222&page=$i>$i</a>|";
	}
...
//------------資料搜尋內容呈現,廠商帳款資料明細--------------------------------------------	
			...
			echo "<td align='center'><a href='vend/vendsupamt_mod2.php?vendno=".$vendno."'>" .$vendname. "</a></td>\n";
