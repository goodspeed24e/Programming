...
<form name='form1' method='post' action='vend/vendaprec_prt2.php?trandate1=" . $row[trandate1] . "&trandate2=" . $row[trandate2] . "&tranvendno1=" . $row[tranvendno1] . "'>
...
至
		...
		<p>廠商編號		</p>
		<p>
		  <input type="text" name="tranvendno1" size="10" value="<?='0000000000'?>">
        </p>
          <p>
