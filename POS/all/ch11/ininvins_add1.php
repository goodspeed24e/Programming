...
//--------------計算總筆數及頁數------------------
	...
	$lista=ceil($total/10);
?>
<form name="form1" method="post" action="ininv/ininvins_add2.php">
...
//--------------頁數選擇呈現及連接---------------
	...
	for($i = 1;$i<=$lista;$i++) 
	{
		echo "  <a href=index.php?Select=360&page=$i>$i</a>|";
	}
...
//-----------------連接新增程式ininvins_add2.php-------------------						
			echo "<td align='center'><a href='index.php?Select=361&vendno=" .$vendno. "'>" .$vendname. "</a></td>\n";
