...
//--------------計算總筆數及頁數------------------
	...
	$lista=ceil($total/10);
?>
<form name="form1" method="post" action="ininv/ininvpur_add2.php?tranpono=' . $purcmtranno . '">
  ...
  <table width="782" border="1" align="center" cellspacing="0" cellpadding="0" >
    <tr bgcolor="#99CCFF"> 
      <td align="center">
		 <?php
//--------------頁數選擇呈現及連接---------------
     echo "依採購單輸入建立進貨資料&nbsp;&nbsp; 第&nbsp";
	for($i = 1;$i<=$lista;$i++) 
	{
		echo "  <a href=index.php?Select=350&page=$i>$i</a>|";
	}
...
// --------------抓取資料表中資料並呈現採購資料-----
			...
			echo "<td align='center'><a href='index.php?Select=351&tranpono=" . $purcmtranno . "'>" . $purcmtranno . "</a></td>\n";
