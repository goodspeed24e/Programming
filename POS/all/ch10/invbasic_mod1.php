...
<form name="form1" method="post" action="inv/invbasic_mod2.php">
...
//--------------頁數選擇呈現及連接---------------
	...
	for($i = 1;$i<=$lista;$i++) 
	{
		echo "  <a href=index.php?Select=302&page=$i>$i</a>|";
	}
...
//------------------------- 抓取資料表中其他資料並呈現----------------------------------
			...
			echo "<td align='center'><a href='inv/invbasic_mod2.php?prodno=" . $prodno . "'>" . $prodname . "</a></td>\n";
