...
<?php 
	...
	$lista=ceil($total/10);
?>
<!------ 傳給 purchmst_del2.php 檔案 ------>
<form name="form1" method="post" action="purchase/purchmst_del2.php?purcmtranno=' . $purcmtranno . '">
  <table width="782" border="1" align="center" cellspacing="0" cellpadding="0" >
    <tr bgcolor="#99CCFF"> 
      <td align="center">
<?php
    //--------------頁數選擇呈現及連接---------------
     echo "刪除採購主資料表中資料&nbsp;&nbsp; 第&nbsp";
	for($i = 1;$i<=$lista;$i++) 
	{
		echo "  <a href=index.php?Select=264&page=$i>$i</a>|";
	}
	...
	<?php
	  ...
	  $res = mysql_query($SQLStr);
       ...
       //---------- 抓取採購主資料表中資料並呈現-------------------
			...
			echo "<td align='center'><a href='purchase/purchmst_del2.php?purcmtranno=" . $purcmtranno . "'>" . $purcmtranno . "</a></td>\n";
