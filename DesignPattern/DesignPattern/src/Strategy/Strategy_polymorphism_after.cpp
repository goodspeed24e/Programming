...
class Strategy_SortImpl {
public:
    virtual void sort(int [], int) = 0;
};

class Strategy_SortBubble: public Strategy_SortImpl{
public:
...
class Strategy_SortShell: public Strategy_SortImpl{
public:
	void sort(int v[], int n)
	{
...
public:
	Strategy_Stat()
	{
		m_impl = new Strategy_SortBubble;
	}
	~Strategy_Stat()
	{
		delete m_impl;
 ...
 * from the clients that use it. (Strategy Pattern = polymorphism)
 * 
